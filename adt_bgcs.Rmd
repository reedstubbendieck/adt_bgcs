...
Figure_1_C <- ggplot() +
  geom_jitter(data = eHOMD_BGCs_by_strain, aes(y=Count, x=genus_type, fill=genus_type), shape = 21, col="black", stroke=0.1, height = 0.1, size=1) +
...
Figure_1_D <- ggplot() +
  geom_jitter(data=eHOMD_genome_info, aes(y=Size_bp, x=count, fill=genus_type), shape = 21, col="black", stroke=0.1, width = 0.25, size=1) +
  ylab("Genome Size (Mb)") +
